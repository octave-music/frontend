      ...
      {showContextMenu && contextMenuOptions && (
        ...
        >
          <div
            ...
            style={{
              top:
                Math.min(contextMenuPosition.y, window.innerHeight - 150) +
                "px",
              left:
                Math.min(contextMenuPosition.x, window.innerWidth - 200) + "px",
            }}
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    >
                      <div
                        className={`p-3 bg-${color}-500/10 text-${color}-400 rounded-lg 
